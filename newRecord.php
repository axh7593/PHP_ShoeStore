...
if(isset($_POST['submit'])){
    ...
    if($ProductName == '' || $Description == '' || $Price == '' || $Quantity == '' || $SalePrice == '' || $ImageName = ''){
        ...
        mysqli_query($con, "INSERT Project1 SET ProductName='$ProductName', Description='$Description',Price='$Price',Quantity='$Quantity',SalePrice='$SalePrice', ImageName='$filename'")
            or die(mysqli_error());
